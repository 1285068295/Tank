...
public class Audio_Teacher {
	...
	public Audio_Teacher(String fileName) {
		try {
			audioInputStream = AudioSystem.getAudioInputStream(Audio_Teacher.class.getClassLoader().getResource(fileName));
	...
	public static void main(String[] args) {
		  Audio_Teacher a = new Audio_Teacher("audio/explode.wav");
